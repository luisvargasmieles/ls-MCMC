function [logPiTrace,mse_from_burnIn,mse_stationarity,...
         firstMoment,secondMoment] = lsMYULA(varargin)
%
% function to sample using proximal MCMC
% algorithm called ls-MYULA (see Algorithm 4.1)
%
%%  =========== inputs ====================
%
% 'true_img'                    : true image
...
for i=2:nBurnIn
    ...
    Xk_grad = invQ(AtY/(sigma^2) + Zk/rho2);
    
    % 2 Sampling the variable Z using MYULA
    Zk = Zk - dt*(Zk - Xk_grad)/rho2 ...
                  - dt*(Zk - proxG(Zk))/lambdaProx ...
